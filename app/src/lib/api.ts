/**
 * api.ts — Snap It & Forget It API client
 * FME Mission 001
...
export const scanApi = {
  ...
  processDocument: (params: {
    ...
    request<ScanResult>('/api/scan/document', {
      method: 'POST',
...
export const ledgerApi = {
  ...
  approve: (ledgerEntryId: string) =>
    request<{ success: boolean }>(`/api/ledger/${ledgerEntryId}/approve`, { method: 'POST' }),
